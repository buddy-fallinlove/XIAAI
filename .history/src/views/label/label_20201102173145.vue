...
<div class="box1">
    ...
    <el-link class="ml mr" @click="Read">已读消息 ({{ this.nuxt.length }})</el-link>
    <el-link class="ml mr" @click="recovery">回收站 ({{ this.nuxt.length }})</el-link>
    <div>
        <el-col :span="8">
            <el-card shadow="never">
                ...
                <div v-if="this.list.length === 0" class="tex">暂无消息</div>
                <div v-if="dataname == 1 && this.list.length !== 0" class="mt">
                    <el-button type="primary" @click="allreaded">全部已读</el-button>
                </div>
                <div v-if="dataname == 2 && this.list.length !== 0" class="mt">
                    <el-button type="primary" @click="alldel">全部删除</el-button>
                </div>
                <div v-if="dataname == 3 && this.list.length !== 0" class="mt">
                    <el-button type="primary" @click="clear">清空回收站</el-button>
                </div>
            </el-card>
        </el-col>
    </div>
