...
<div class="df fd_c">
    ...
    <div class="df">
        <div class="mr">
            <download-excel class="export-excel-wrapper" :data="tableData" :fields="json_data" name="filename.xls">
                <el-button type="primary">导出xls</el-button>
            </download-excel>
        </div>
        <div class="ml">
            <download-excel class="export-excel-wrapper" :data="tableData" :fields="json_data" name="filename.csv" type="csv">
        ...
        getdata() {
            axios
                ...
                .then((res) => {
                    ...
                    this.tableData = this.tableData1.slice((currentPage - 1) * pagesize, currentPage * pagesize)
                })
                .catch((err) => {
                    console.log(err);
                });
