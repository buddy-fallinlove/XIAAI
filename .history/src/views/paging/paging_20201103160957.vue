        ...
        <div>
            <el-dialog title="修改内容" :visible.sync="dialogFormVisible">
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button @click="cancelEdit(tableData)">取 消</el-button>
                    <el-button type="primary" @click="addUser(tableData)">确 定</el-button>
                </div>
            </el-dialog>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        modify(scope) {
            ...
            this.tableData.NAME = scope.row.NAME;
            this.tableData.ORI_PRICE = scope.row.ORI_PRICE;
            this.tableData.PRESENT_PRICE = scope.row.PRESENT_PRICE;
        },
        // inbut事件
        search() {
            if (this.input === "") {
