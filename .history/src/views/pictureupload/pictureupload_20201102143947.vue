        ...
        <el-card shadow="always">
            ...
            <div>
                ...
                <div id="image">
                    ...
                    <my-upload @crop-success="cropSuccess" @crop-upload-success="cropUploadSuccess" @crop-upload-fail="cropUploadFail" v-model="show" :width="20" :height="20" img-format="png" :size="size" langType="zh" :noRotate="false" field="file" url="/api/upload"></my-upload>
                    <img :src="imgDataUrl" />
                </div>
            </div>
        </el-card>
