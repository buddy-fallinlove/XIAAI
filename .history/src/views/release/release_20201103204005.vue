                ...
                <el-form :model="form" :rules="rules" ref="form" label-width="90px">
                    ...
                    <div class="df jc_b">
                        ...
                        <el-form-item label="发表时间" prop="date">
                            <div class="block">
                                <el-date-picker v-model="form.date" type="date" placeholder="选择日期时间" align="right" :picker-options="pickerOptions"></el-date-picker>
                            </div>
                        </el-form-item>
    ...
    methods: {
        ...
        release() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    console.log("qq", dayjs(this.form.date).format("YYYY年MM月DD日  HH时mm分ss秒"))
                    axios
